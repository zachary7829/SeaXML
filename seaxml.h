...
#include <string.h>
#include <stdlib.h>
char * getvalue(char *dict, int occurrence) {
    //system("clear");
    int c = 0;
    int tempint = 0;
    int charindex = 0;
    ...
    char value[strlen(dictkey)*10];
    int keylength = strlen(dictkey);
    int occurrenceindex = 1;
    FILE *fp = fopen("AfterButter.dhortcut", "r");
    char line[100];
